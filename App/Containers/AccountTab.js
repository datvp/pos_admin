...
import styles from './Styles/AccountTab';
import { Images } from '../Themes';

class AccountTab extends PureComponent {
  componentWillMount() {
  ...
  render() {
    ...
    return (
      <Container style={styles.mainContainer}>
        <NavBar
          title={isLoggedIn ? name : 'Account'}
          showBackButton={isEdit}
          renderRight={isLoggedIn ? this._renderRightHeader : undefined}
          onBackPress={isEdit ? this._cancelEdit : null}
